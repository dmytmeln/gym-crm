...
public class CsvDtoTestFactory {
    ...
    public static final String DEFAULT_CSV_USERNAME = "liam.miller";
    public static final String DEFAULT_CSV_FIRST_NAME = "Liam";
    public static final String DEFAULT_CSV_LAST_NAME = "Miller";
    ...
    public static TraineeCsvDto buildTraineeCsvDto() {
    ...
    public static TrainerCsvDto buildTrainerCsvDto() {
    ...
    public static TrainingCsvDto buildTrainingCsvDto() {
